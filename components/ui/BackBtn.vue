<template>
  <div class="back-btn" :class="className" @click="$router.go(-1)">
    <div class="back-btn__arrow">
    ...
    <div class="back-btn__label">
      {{ 'back_to' | localize(locale) }} {{ label | localize(locale) }}
    </div>
  </div>
</template>
